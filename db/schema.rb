...
ActiveRecord::Schema[7.0].define(version: 2026_09_02_124644) do
  ...
  create_table "report_mentions", force: :cascade do |t|
    ...
    t.index ["mentioning_report_id", "mentioned_report_id"], name: "index_report_mentions_uniqueness", unique: true
